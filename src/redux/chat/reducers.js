...
const INIT_STATE = {
    ...
    users: [
        ...
        {
            id: 0, name: "Sam Hendricks", profilePicture: avatar2, status: "online", unRead: 0, roomType: "contact", isGroup: false,
            messages: [
        ...
        {
            id: 4, name: "Doris Brown", profilePicture: avatar4, status: "online", unRead: 0, isGroup: false, isTyping: false,
            messages: [
